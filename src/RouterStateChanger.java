...
public class RouterStateChanger implements Runnable {
    ...
    public void revertRandomRouter() {
        ...
        String rState = NetworkLayerServer.routers.get(id).getState() ? "UP" : "Down";
        System.out.println("State Changed; Router ID: "+NetworkLayerServer.routers.get(id).getRouterId() + "\tCurrent State: " + rState);
